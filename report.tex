...
\section*{Methodology}
To investigate this idea, we will create a simple model of the economy by assigning each individual a per-timestep income, 
...
To measure the results of our simulation, we will use the Gini coefficient, which measures the level of inequality in a society, 
and a mobility measure, which calculates the proportion of people who moved by more than one quintile.\\
We will run simulations with different ratios of return on capital to growth due to income and compare the results to see if increasing the return on capital leads to higher inequality.
